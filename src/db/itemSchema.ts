// TODO: convert into MongoDB driver from: https://deno.land/x/mongo@v0.31.1
import mongoose, { InferSchemaType, Schema } from 'npm:mongoose'
...
// Delete and modify unwanted fields from the responseitemScema.set('toJSON', {
transfor: (_ocment, returned) => {
